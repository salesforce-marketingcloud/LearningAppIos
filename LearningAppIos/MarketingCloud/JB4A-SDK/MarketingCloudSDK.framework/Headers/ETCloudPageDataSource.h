 ...
 */
@property (nonatomic, readonly, copy, nullable) NSArray<__kindof ETCloudPage *>*messages __attribute__((deprecated("__REPLACEME__")));

/**
 This is a reference to the tableview in your UIViewController. We need a reference to it to reload data periodically.
 @deprecated in __DOC_REPLACEME__
 */
@property (nonatomic, weak, nullable) UITableView *inboxTableView __attribute__((deprecated("__REPLACEME__")));
