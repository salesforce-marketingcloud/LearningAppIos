//
//  ETInternalLandingPagePresenter.h
//  JB4A-SDK-iOS
//
...
/**
 ...
 THIS IS OUR INTERNAL VERSION of the Landing Page Presenter that will use WKWebView if it is available
 */
@interface ETInternalLandingPagePresenter : UIViewController<UIWebViewDelegate,WKNavigationDelegate>
{
    UIView *_theWebView;
    UILabel *_pageTitle;
}
...
/**
 ...
 @return ETInternalLandingPagePresenter value. instancetype value is self(ETInternalLandingPagePresenter)
 */
