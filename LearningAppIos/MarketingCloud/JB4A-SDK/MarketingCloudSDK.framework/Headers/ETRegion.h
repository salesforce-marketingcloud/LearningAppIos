 ...
 */
@property (nonatomic, copy, nullable) NSString *fenceIdentifier __attribute__((deprecated("__REPLACEME__")));
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
@property (nonatomic, copy, nullable) NSNumber *latitude __attribute__((deprecated("__REPLACEME__")));
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
@property (nonatomic, copy, nullable) NSNumber *longitude __attribute__((deprecated("__REPLACEME__")));

/**
 For geofences only, the radius of the fence. This number, an integer, is in meters. 
 @deprecated in __DOC_REPLACEME__
 */
@property (nonatomic, copy, nullable) NSNumber *radius __attribute__((deprecated("__REPLACEME__")));
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
@property (nonatomic, readonly, copy, nullable) NSArray *messages __attribute__((deprecated("__REPLACEME__")));

/**
 For beacons, the Proximity UUID of the beacon. 
 @deprecated in __DOC_REPLACEME__
 */
@property (nonatomic, copy, nullable) NSString *proximityUUID __attribute__((deprecated("__REPLACEME__")));

/**
 For beacons, the Major number. This is a uint32 per the CLBeaconRegion spec.
 @deprecated in __DOC_REPLACEME__
 */
@property (nonatomic, copy, nullable) NSNumber *majorNumber __attribute__((deprecated("__REPLACEME__")));

/** 
 For beacons, the Minor number. This is a uint32 per the CLBeaconRegion spec.
 @deprecated in __DOC_REPLACEME__
 */
@property (nonatomic, copy, nullable) NSNumber *minorNumber __attribute__((deprecated("__REPLACEME__")));

/**
 This is the number of times a region is entered as counted by the ETLocationManager. 
 @deprecated in __DOC_REPLACEME__
 */
@property (nonatomic, readonly, copy, nullable) NSNumber *entryCount __attribute__((deprecated("__REPLACEME__")));

/**
 This is the number of times a region is exited as counted by the ETLocationManager. Ideally, it matches enter count.
 @deprecated in __DOC_REPLACEME__
 */
@property (nonatomic, readonly, copy, nullable) NSNumber *exitCount __attribute__((deprecated("__REPLACEME__")));

/**
 This is the name which is set on SalesforceMarketingCloud, while setting the ETRegion
 @deprecated in __DOC_REPLACEME__
 */
@property (nonatomic, copy, nullable) NSString *regionName __attribute__((deprecated("__REPLACEME__")));
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
@property (nonatomic, assign) MobilePushGeofenceType locationType __attribute__((deprecated("__REPLACEME__")));

/** 
 For ETGenericUpdate, this is the type of request that is being initiated. It will soon be deprecated. 
 @deprecated in __DOC_REPLACEME__
 */
@property (nonatomic) ETRegionRequestType requestType __attribute__((deprecated("__REPLACEME__")));
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
-(BOOL)isEqualToRegion:(ETRegion *)region DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
-(nullable CLLocation *)regionAsLocation DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__"); // For Geofences
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
-(nullable CLRegion *)regionAsCLRegion DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__"); // For Beacons
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
-(nullable CLBeaconRegion *)regionAsBeaconRegion DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__"); // Also for beacons
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
-(BOOL)isGeofenceRegion DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
-(BOOL)isBeaconRegion DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
+(nullable ETRegion*)getRegionByIdentifier:(NSString *)identifier DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
+(nullable ETRegion*)getBeaconRegionForRegionWithProximityUUID:(NSString *)proximityUUID andMajorNumber:(NSNumber *)majorNumber andMinorNumber:(NSNumber *)minorNumber DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
+(nullable ETRegion *)getBeaconRegionForRegionWithProximityUUID:(NSString *)proximityUUID DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
+(nullable NSSet<__kindof ETRegion*> *)getFencesFromCache DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
+(nullable NSSet<__kindof ETRegion*> *)getFencesFromCacheIncludingInactive:(BOOL)getInactive DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
+(BOOL)invalidateAllRegionsForRequestType:(ETRegionRequestType)requestType DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");
...
/**
 ...
 @deprecated in __DOC_REPLACEME__
 */
+(BOOL)invalidateAllRegions DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");

/**
 Begins fence retrieval from ET of Geofences. 
 @deprecated in __DOC_REPLACEME__
 */
+(void)retrieveGeofencesFromET DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");

/** 
 Begins fence retrieval from ET of Beacons.
 @deprecated in __DOC_REPLACEME__
 */
+(void)retrieveProximityFromET DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");

+(BOOL)generatePersistentDataSchemaInDatabase DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");

-(nullable ETEventRegion *)regionAsETEventRegion DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");
