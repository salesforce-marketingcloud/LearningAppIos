 ...
 */
- (instancetype)initWithPrice:(NSNumber *)price quantity:(NSNumber *)quantity item:(NSString *)item NS_DESIGNATED_INITIALIZER DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");
