 ...
 */
- (instancetype)initWithOrderNumber:(NSString *) orderNumber shipping:(NSNumber *) shipping discount:(NSNumber *) discount cart:(PICart *) cart NS_DESIGNATED_INITIALIZER DEPRECATED_MSG_ATTRIBUTE("__REPLACEME__");
