# This version of the MobilePush SDK LearningApp has been DEPRECATED. You can find the new version [here](https://github.com/salesforce-marketingcloud/MarketingCloudSDK-iOS/tree/master/LearningApp).
